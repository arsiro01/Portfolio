  ...
  return (
    <>
      ...
      <motion.p 
        ...
        >
        Proficient in both Full Stack Development and AI Engineering, my goal is
        to drive innovation and create impactful solutions. With expertise in
        front-end and back-end technologies such as HTML, CSS, JavaScript,
        React, Node.js, as well as in-depth knowledge of machine learning
